...
@Composable
fun NotificationScreenHost(navController: NavController, authViewmodel: AuthViewModel) {
...
@Composable
private fun Add() {
    NotificationScreenHost(navController = rememberNavController(), authViewmodel = viewModel())
}